-- Get Index Reference fron Plan Cache 


SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED 

DECLARE @IndexName AS NVARCHAR(128) = 'IX_BorrowerLoanPayments_BorrowerLoanID_PaymentNumber_INCLUDES';
...
cp.plan_handle, 
query_plan ,OBJECT_NAME(qp.objectid)
