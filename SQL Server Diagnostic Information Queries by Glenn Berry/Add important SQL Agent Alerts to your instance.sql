...
DECLARE @OperatorName sysname = N'sandip.patel@ratesetter.com';
...
EXEC msdb.dbo.sp_add_alert @name=N'41405 - AG is not ready for automatic failover', 
		...
		@job_id=N'00000000-0000-0000-0000-000000000000'
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'1480 - AG Role Change'                         , @operator_name=N'SQLAlerts', @notification_method = 1
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'35264 - AG Data Movement - Suspended' 			, @operator_name=N'SQLAlerts', @notification_method = 1
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'35265 - AG Data Movement - Resumed'			, @operator_name=N'SQLAlerts', @notification_method = 1
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'41404 - AG is offline'							, @operator_name=N'SQLAlerts', @notification_method = 1
GO
EXEC msdb.dbo.sp_add_notification @alert_name=N'41405 - AG is not ready for automatic failover', @operator_name=N'SQLAlerts', @notification_method = 1
GO